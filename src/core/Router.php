...
class Router {
     ...
     * @access public
     */
    public function __construct($server, $routes=null) {
        $this->server = $server;
        $this->routes = $routes;
    }
    ...
    public function parse() {
        ...
        $this->controller = $pathTokens[0];
        $this->action = $pathTokens[1];
        
        $this->controllerClass = ucfirst($pathTokens[0]) . 'Controller';
